...
Ознакомьтесь с [руководством по работе в терминале](https://github.com/netology-code/ibb-homeworks/blob/IBB-29/terminal/terminal.md) для вашей операционной системы.
